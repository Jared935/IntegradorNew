...
class PostresScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final postres = productsProvider.getProductsByCategory('Postres');
      ...
      child: ListTile(
        leading: Container(
          ...
          decoration: BoxDecoration(
            color: _getDessertColor(product.name),
  ...
  Color _getDessertColor(String dessertName) {
    if (dessertName.toLowerCase().contains('pay')) {
      return Colors.yellow[100]!;
    } else if (dessertName.toLowerCase().contains('flan')) {
      return Colors.orange[100]!;
    } else if (dessertName.toLowerCase().contains('galleta')) {
